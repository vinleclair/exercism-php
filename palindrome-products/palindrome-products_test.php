...
class PalindromeProductsTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertFalse(isPalindrome(435));
    }

    public function testPalindromeProducts()
    {
        $this->assertEquals([1, 2, 3, 4, 5, 6, 7, 8, 9], palindromeProducts(1, 9));
    }

    public function testFactors()
    {
        $this->assertEquals([[1,9], [3,3]], factorsInRange(9, 1, 9));
    }
